...
#ifndef ENGINE3D_SRC_INPUTSTATES_HPP
#define ENGINE3D_SRC_INPUTSTATES_HPP

#define INPUT_AXIS_X 0
#define INPUT_AXIS_Y 1
#define INPUT_AXIS_MOUSE_X 2
#define INPUT_AXIS_MOUSE_Y 3
#define INPUT_AXIS_SCROLL_WHEEL 4
#define NUM_INPUT_AXIS 5
...
#define JOYSTICK_CENTERED 0
#define JOYSTICK_UP 1
#define JOYSTICK_RIGHT 2
#define JOYSTICK_DOWN 4
#define JOYSTICK_LEFT 8
#define JOYSTICK_RIGHT_UP (JOYSTICK_RIGHT | JOYSTICK_UP)
#define JOYSTICK_RIGHT_DOWN (JOYSTICK_RIGHT | JOYSTICK_DOWN)
#define JOYSTICK_LEFT_UP (JOYSTICK_LEFT | JOYSTICK_UP)
#define JOYSTICK_LEFT_DOWN (JOYSTICK_LEFT | JOYSTICK_DOWN)
...
#endif //ENGINE3D_SRC_INPUTSTATES_HPP
